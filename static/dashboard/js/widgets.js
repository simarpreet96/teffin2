(function($) {
  ...
  gradientStroke2.addColorStop(0, '#e16129');

  var gradientFill2 = ctx.createLinearGradient(0, 0, 0, 450);
  gradientFill2.addColorStop(0, "#e161291a");
  gradientFill2.addColorStop(1, "#e161291a");
  ...
  gradientStrokePeercoin.addColorStop(0, '#e16129');

  var gradientFillPeercoin = peerCoinCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillPeercoin.addColorStop(0, "#e161291a");
  gradientFillPeercoin.addColorStop(1, "#e161291a");
